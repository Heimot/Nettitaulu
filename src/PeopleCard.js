      ...
      <div className="myDiv">
        <Card>
          <CardBlock>
            ...
            {kukka.kukka1.toimi !== 0 ? <CardText><CardText className="label">{kukka.kukka1.name}</CardText><CardText className="label">{kukka.kukka1.toimi}</CardText><CardText className="label">{kukka.kukka1.kerays}</CardText></CardText> : undefined}
